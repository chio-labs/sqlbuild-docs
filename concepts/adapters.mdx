...
|---------|--------|---------|
| [DuckDB](#duckdb) | Supported | included by default |
| [Snowflake](#snowflake) | Supported | `sqlbuild[snowflake]` |
| [BigQuery](#bigquery) | Supported | `sqlbuild[bigquery]` |
| [Databricks](#databricks) | Supported | `sqlbuild[databricks]` |
