...
description: "Opt into change-aware builds for your existing dbt project. No SQLBuild models and no migration."
---
...
<Frame>
  <img src="/dbt-reuse.gif" alt="Pointing SQLBuild at a dbt project: with --changes-only, the first build runs the edited models and the second build skips everything because all planned dbt models are current" />
</Frame>
