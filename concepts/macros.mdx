...
Project variables are simple string substitutions defined in `sqlbuild_project.toml` or per-environment. They use the `@name` syntax (without parentheses) and are distinct from macros:
