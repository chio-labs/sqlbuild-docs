...
This is a native SQLBuild warehouse-to-warehouse workflow. dbt interop does not apply this reuse policy automatically; use explicit [`sqb dbt clone`](/concepts/dbt-compatibility/clone) when you need selected dbt-built relations copied from a production-shaped git ref.
