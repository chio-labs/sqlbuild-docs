...
For an existing warehouse schema, use [Contract Adoption](/concepts/contract-adoption) to compare or
generate repository declarations explicitly. Ordinary compilation remains offline.
