---
title: "Configuration"
description: "MODEL() header fields and SQL-analysis controls."
---
...
| `migrate_from` | Old model name (or `schema.name`) whose data this model takes over; see [Model migrations](/concepts/models/migrations). Also valid on snapshot models |
