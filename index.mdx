...
- **Low, dbt-like floor** - familiar SQL models, no new paradigm to learn.
- **Beyond transformation** - ingestion, Python tasks/assets/checks, pre-promotion audit gating, and local E2E testing, in one tool.
- **Opt-in virtual environments** - instant low-copy branching and promotion when you want it, never forced.
- **Runs alongside dbt** - point it at an existing project and adopt incrementally.
