...
DuckDB runs entirely locally, so you can try SQLBuild and run full E2E tests without any warehouse credentials. See [Adapters](/concepts/adapters) for setup details.
...
<Frame>
  <img src="/sqlbuild_diff_hq.png" alt="SQLBuild diff output showing schema comparison, row-level differences, and changed column values between prod and dev environments" />
</Frame>
