...
Detect SQL changes, automatically trigger rebuilds, and validate data before promotion.
...
<CardGroup cols={2}>
  ...
  <Card title="Column Lineage" icon="diagram-project" href="/concepts/column-lineage">
    Trace columns through your pipeline.
  </Card>
</CardGroup>
